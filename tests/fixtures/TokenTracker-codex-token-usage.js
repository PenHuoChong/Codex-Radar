// Vendored compatibility fixture for synthetic tests only.
//
// Source: https://github.com/xiufengsun/TokenTracker/blob/f15ca22b458e84fc8ad6a545a8d4d5ed4b915307/src/lib/codex-token-usage.js
// Upstream: xiufengsun/TokenTracker, commit f15ca22b458e84fc8ad6a545a8d4d5ed4b915307 (2026-09-10)
// License: MIT; full text is retained in tests/fixtures/TokenTracker-LICENSE.txt
// (https://github.com/xiufengsun/TokenTracker/blob/f15ca22b458e84fc8ad6a545a8d4d5ed4b915307/LICENSE)
// This copy is retained solely to make the cross-validation test deterministic
// and does not read or install any TokenTracker package.
...
function consumeUsageDelta(state, lastUsage, totalUsage) {
  ...
  if (active && !totalsReset(total, active)) {
    ...
    // append_last_usage path. Treat it as a new stream instead of charging
